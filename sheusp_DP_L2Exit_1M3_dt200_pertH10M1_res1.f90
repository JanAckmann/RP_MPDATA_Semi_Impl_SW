...
DOUBLE PRECISION :: D_Adv(N,M), P0_HP_pert(N,M), &
         &          P0_512x256(514,256),   &
         &              pert
...
call random_seed()
  DO J=1,M
    DO I=2,N-1
      ...
      P0_HP_pert(I,J)= P0_HP(I,J)*(pert-0.5d0)*0.002d0
    end do
  end do
  pert=0.0d0
  DO J=1,M
    DO I=2,N-1
      pert=pert+P0_HP_pert(I,J)
    end do
  end do
  pert=pert/((N-2)*M)
!  write(*,*) pert
  DO J=1,M
    DO I=2,N-1
      P0_HP(I,J)=P0_HP(I,J)+P0_HP_pert(I,J)-pert
    end do
  end do
call XBC(P0_HP,N,M)
...
!do J=1,M
!
!write(*,*) P0_HP(:,J), P0_HP_pert(:,J)-pert
!read(*,*)
!enddo
...
call random_seed()
  DO J=1,M
    DO I=2,N-1
      CALL RANDOM_NUMBER(pert)
      PT_HP(I,J)=PT_HP(I,J)+(pert-0.5d0)*G*0.2d0
    end do
  end do
!call random_seed()
!  DO J=1,M
!    DO I=2,N-1
!      CALL RANDOM_NUMBER(pert)
!      P0_HP_pert(I,J)= PT_HP(I,J)*(pert-0.5d0)*0.2d0*10**(-3.0d0)
!  ! write(*,*) pert, (pert-0.5d0)*0.2d0*10**(-4.0d0),PT_HP(I,J) ,P0_HP_pert(I,J)
!    end do
!  !  read(*,*)
!  end do
!  pert=0.0d0
...
!  DO J=1,M
!    DO I=2,N-1
!      PT_HP(I,J)=PT_HP(I,J)+P0_HP_pert(I,J)-pert
!    end do
!  end do
!call XBC(PT_HP,N,M)
